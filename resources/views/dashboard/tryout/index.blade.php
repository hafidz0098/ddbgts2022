    ...
    <div class="col-lg-8">
        ...
        <form method="POST" action="/dashboard/email/tryout">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('link_to') is-invalid @enderror" id="link_to" name="link_to" placeholder="Masukkan link TO" autofocus value="https://us02web.zoom.us/j/87673028345?pwd=Ny9WRDgzUUxUYlVvUkhnQUpyNEJvZz09" >
                @error('link_to')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
